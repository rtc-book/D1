...
<!-- image from https://i.ytimg.com/vi/b5ZNBc99OnU/maxresdefault.jpg with online overlay tool https://fbutube.com/add-play-button-to-image -->
...
2. Install the Extension Pack (same page).
    <img style="display: block;margin-left: auto;margin-right: auto;width: 50%;" alt="Screen shot of the Virtualbox Downloads page" src="https://user-images.githubusercontent.com/4192991/152072318-94136b66-fc61-4aa0-aee1-6931bdeb020e.png">
...
<img src="docs/figures/repair-connection-to-myrio.png" alt="screenshot" style="display: block;margin-left: auto;margin-right: auto;width: 50%;">
